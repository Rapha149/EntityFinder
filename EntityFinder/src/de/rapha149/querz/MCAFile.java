...
public class MCAFile {
	...
	/**
	 * MCAFile represents a world save file used by Minecraft to store world data on
	 * the hard drive. This constructor needs the x- and z-coordinates of the stored
	 * region, which can usually be taken from the file name {@code r.x.z.mca}
	 * 
	...
	/**
	 * Reads an .mca file from a {@code RandomAccessFile} into this object. This
	 ...
	 * 
	 * @param raf       The {@code RandomAccessFile} to read from.
	 * @param loadFlags A logical or of {@link LoadFlags} constants indicating what
	...
	/**
	 * Calls {@link MCAFile#serialize(RandomAccessFile, boolean)} without updating
	 * any timestamps.
	 * 
	...
	/**
	 * Serializes this object to an .mca file. This method does not perform any
	 * cleanups on the data.
	 * 
	 * @param raf              The {@code RandomAccessFile} to write to.
	...
	/**
	 * Set a specific Chunk at a specific index. The index must be in range of 0 -
	 * 1023.
	 * 
	...
	/**
	 * Set a specific Chunk at a specific chunk location. The x- and z-value can be
	 * absolute chunk coordinates or they can be relative to the region origin.
	 * 
	 ...
	 * @return The biome id if the chunk exists and the chunk has biomes, otherwise
	 *         -1.
	 */
	...
	/**
	 * Set a block state at a specific block location. The block coordinates can be
	 * absolute coordinates or they can be relative to the region.
	 * 
	 * @param blockX  The x-coordinate of the block.
	 * @param blockY  The y-coordinate of the block.
	 * @param blockZ  The z-coordinate of the block.
	 * @param state   The block state to be set.
	 * @param cleanup Whether the Palette and the BLockStates should be recalculated
	 *                after adding the block state.
	 */
	...
	/**
	 * Fetches a block state at a specific block location. The block coordinates can
	 * be absolute coordinates or they can be relative to the region.
	 * 
	 * @param blockX The x-coordinate of the block.
	 * @param blockY The y-coordinate of the block.
	 * @param blockZ The z-coordinate of the block.
	 * @return The block state or <code>null</code> if the chunk or the section do
	 *         not exist.
	 */
	...
	/**
	 * Recalculates the Palette and the BlockStates of all chunks and sections of
	 * this region.
	 */
