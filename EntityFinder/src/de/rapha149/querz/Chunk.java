...
import static net.querz.mca.LoadFlags.BIOMES;
import static net.querz.mca.LoadFlags.BLOCK_LIGHTS;
import static net.querz.mca.LoadFlags.BLOCK_STATES;
import static net.querz.mca.LoadFlags.CARVING_MASKS;
import static net.querz.mca.LoadFlags.ENTITIES;
import static net.querz.mca.LoadFlags.HEIGHTMAPS;
import static net.querz.mca.LoadFlags.LIGHTS;
import static net.querz.mca.LoadFlags.LIQUIDS_TO_BE_TICKED;
import static net.querz.mca.LoadFlags.LIQUID_TICKS;
import static net.querz.mca.LoadFlags.POST_PROCESSING;
import static net.querz.mca.LoadFlags.SKY_LIGHT;
import static net.querz.mca.LoadFlags.STRUCTURES;
import static net.querz.mca.LoadFlags.TILE_ENTITIES;
import static net.querz.mca.LoadFlags.TILE_TICKS;
import static net.querz.mca.LoadFlags.TO_BE_TICKED;
